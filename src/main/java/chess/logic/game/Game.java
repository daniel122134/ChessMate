...
public class Game {
    ...
    public Game() {
        Piece[][] matrix = {
            {new Rook(PlayerColors.BLACK, new Point(0, 0)), new Knight(PlayerColors.BLACK, new Point(1, 0)), new Bishop(PlayerColors.BLACK, new Point(2, 0)), new Queen(PlayerColors.BLACK, new Point(3, 0)),
             new King(PlayerColors.BLACK, new Point(4, 0)), new Bishop(PlayerColors.BLACK, new Point(5, 0)), new Knight(PlayerColors.BLACK, new Point(6, 0)), new Rook(PlayerColors.BLACK, new Point(7, 0))},
            ...
            {new Rook(PlayerColors.WHITE, new Point(0, 7)), new Knight(PlayerColors.WHITE, new Point(1, 7)), new Bishop(PlayerColors.WHITE, new Point(2, 7)), new Queen(PlayerColors.WHITE, new Point(3, 7)),
             new King(PlayerColors.WHITE, new Point(4, 7)), new Bishop(PlayerColors.WHITE, new Point(5, 7)), new Knight(PlayerColors.WHITE, new Point(6, 7)), new Rook(PlayerColors.WHITE, new Point(7, 7))}
